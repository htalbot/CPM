...
#ifndef CPMFOOFRAME_H
#define CPMFOOFRAME_H
...
class CPMFooFrame: public wxFrame {
public:
    // begin wxGlade: CPMFooFrame::ids
    // end wxGlade

    CPMFooFrame(wxWindow* parent, int id, const wxString& title, const wxPoint& pos=wxDefaultPosition, const wxSize& size=wxDefaultSize, long style=wxDEFAULT_FRAME_STYLE);
    void set_app_layer(CPMFooAppLayer * app_layer)
    {
...
private:
    // begin wxGlade: CPMFooFrame::methods
    void set_properties();
    void do_layout();
    // end wxGlade

protected:
    // begin wxGlade: CPMFooFrame::attributes
