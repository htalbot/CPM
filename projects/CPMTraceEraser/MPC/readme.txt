...
- CPMTraceEraser_dependencies.mpb

    This base project file contains the dependencies of CPMTraceEraser.
    This file should not be updated manually except for the
    first line (project).

- CPMTraceEraser_ex.mpb
...
to $DPO2_CORE_ROOT/doc/MPC/base_project_definition.txt.
