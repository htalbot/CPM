...
BEGIN_EVENT_TABLE(XyzFrame, wxFrame)
    ...
    EVT_BUTTON(wxID_ANY, XyzFrame::on_button_dummy)
    EVT_CHECKBOX(wxID_ANY, XyzFrame::on_checkbox_console)
    // end wxGlade

    EVT_CLOSE(XyzFrame::on_close)

END_EVENT_TABLE();


void XyzFrame::on_button_dummy(wxCommandEvent &event)
{
    wxMessageBox("You hit me!");
    ACE_DEBUG((LM_DEBUG, "You hit me!\n")); // To test console
}

void XyzFrame::on_checkbox_console(wxCommandEvent &event)
{
...
void XyzFrame::on_close(wxCloseEvent& event)
{
